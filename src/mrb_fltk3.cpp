...
#define CONTEXT_SETUP(t) \
    ...
    value_context = mrb_iv_get(mrb, self, mrb_intern(mrb, "context", 7)); \
...
mrb_fltk3_widget_box_get(mrb_state *mrb, mrb_value self)
{
  ...
  struct RClass* _class_fltk3_Box = mrb_class_ptr(mrb_const_get(mrb, mrb_obj_value(_class_fltk3), mrb_intern(mrb, "Box",3)));
  mrb_value args[1];
...
mrb_fltk3_widget_box_set(mrb_state *mrb, mrb_value self)
{
  ...
  if (!mrb_nil_p(box)) {
    ...
    box_value_context = mrb_iv_get(mrb, box, mrb_intern(mrb, "context", 7));
...
mrb_fltk3_widget_image_get(mrb_state *mrb, mrb_value self)
{
  CONTEXT_SETUP(Widget);
  struct RClass* _class_fltk3 = mrb_class_get(mrb, "FLTK3");
  struct RClass* _class_fltk3_Image = mrb_class_ptr(mrb_const_get(mrb, mrb_obj_value(_class_fltk3), mrb_intern(mrb, "Image", 5)));
  mrb_value args[1];
  args[0] = mrb_obj_value(
    Data_Wrap_Struct(mrb, mrb->object_class,
...
mrb_fltk3_widget_image_set(mrb_state *mrb, mrb_value self)
{
  ...
  if (!mrb_nil_p(image)) {
    ...
    image_value_context = mrb_iv_get(mrb, image, mrb_intern(mrb, "context", 7));
...
_mrb_fltk3_widget_callback(fltk3::Widget* v, void* data)
{
  ...
  mrb_value proc = mrb_iv_get(mrb, context->instance, mrb_intern(mrb, "callback", 8));
  mrb_value value = mrb_iv_get(mrb, context->instance, mrb_intern(mrb, "value", 5));
...
mrb_fltk3_widget_callback(mrb_state *mrb, mrb_value self)
{
  ...
  if (!mrb_nil_p(b)) {
    mrb_iv_set(mrb, self, mrb_intern(mrb, "callback", 8), b);
    mrb_iv_set(mrb, self, mrb_intern(mrb, "value", 5), v);
...
mrb_fltk3_group_resizable_get(mrb_state *mrb, mrb_value self)
{
  CONTEXT_SETUP(Widget);
  struct RClass* _class_fltk3 = mrb_class_get(mrb, "FLTK3");
  struct RClass* _class_fltk3_Widget = mrb_class_ptr(mrb_const_get(mrb, mrb_obj_value(_class_fltk3), mrb_intern(mrb, "Widget", 6)));
  mrb_value args[1];
  args[0] = mrb_obj_value(
    Data_Wrap_Struct(mrb, mrb->object_class,
...
mrb_fltk3_group_resizable_set(mrb_state *mrb, mrb_value self)
{
  ...
  arg_value_context = mrb_iv_get(mrb, arg, mrb_intern(mrb, "context", 7));
...
{                                                                         \
  ...
  if (arg_check("o", argc, argv)) {                                       \
    ...
    mrb_iv_set(mrb, self, mrb_intern(mrb, "context", 7), argv[0]);           \
    return self;                                                          \
  ...
  mrb_iv_set(mrb, self, mrb_intern(mrb, "context", 7), mrb_obj_value(        \
    Data_Wrap_Struct(mrb, mrb->object_class,                              \
...
{                                                                         \
  ...
  if (!mrb_nil_p(arg)) {                                                  \
    ...
    mrb_iv_set(mrb, self, mrb_intern(mrb, "context",7), arg);               \
...
mrb_mruby_fltk3_gem_init(mrb_state* mrb)
{
  ...
  mrb_define_module_function(mrb, _class_fltk3_Image, "release", [] (mrb_state* mrb, mrb_value self) -> mrb_value {
    ...
    mrb_iv_set(mrb, self, mrb_intern(mrb, "context",7), mrb_nil_value());
    return mrb_nil_value();
  }, ARGS_REQ(1));
  ...
  mrb_define_method(mrb, _class_fltk3_MenuBar, "menu", [] (mrb_state* mrb, mrb_value self) -> mrb_value {
    CONTEXT_SETUP(Widget);
    struct RClass* _class_fltk3 = mrb_class_get(mrb, "FLTK3");
    struct RClass* _class_fltk3_MenuItem = mrb_class_ptr(mrb_const_get(mrb, mrb_obj_value(_class_fltk3), mrb_intern(mrb, "MenuItem",8)));
    mrb_value args[1];
    args[0] = mrb_obj_value(
      Data_Wrap_Struct(mrb, mrb->object_class,
  ...
  mrb_define_method(mrb, _class_fltk3_TextDisplay, "buffer", [] (mrb_state* mrb, mrb_value self) -> mrb_value {
    CONTEXT_SETUP(Widget);
    struct RClass* _class_fltk3 = mrb_class_get(mrb, "FLTK3");
    struct RClass* _class_fltk3_TextBuffer = mrb_class_ptr(mrb_const_get(mrb, mrb_obj_value(_class_fltk3), mrb_intern(mrb, "TextBuffer",10)));
    mrb_value args[1];
    args[0] = mrb_obj_value(
      Data_Wrap_Struct(mrb, mrb->object_class,
  ...
  mrb_define_method(mrb, _class_fltk3_TextDisplay, "buffer=", [] (mrb_state* mrb, mrb_value self) -> mrb_value {
    ...
    textbuffer_value_context = mrb_iv_get(mrb, textbuffer, mrb_intern(mrb, "context",7));
